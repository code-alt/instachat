...
div {
  ...
  <ul id="scene" class="scene unselectable"
    ...
    <li class="layer" data-depth="0.20"><h1 class="title">Insta<em>chat</em><br><em>open</em>-source social media<br></h1></li>
      ...
      <h1 style="position:absolute;left: 50%;bottom:2px;-webkit-transform:translateX(-50%);transform:translateX(-50%);">
        ➡ ➡ ➡
      </h1>
</main>
    <a href="/explore">
      <div class="move-left" style="background:#56459C;color:#fff;position:fixed;bottom:15px;border-radius:10px 0px 0px 10px;font-family:'Open Sans', sans-serif;cursor:pointer;z-index:100000;" >
        Explore &nbsp; :)
      </div>
    </a>
